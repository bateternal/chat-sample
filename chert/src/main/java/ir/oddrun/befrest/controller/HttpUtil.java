package ir.oddrun.befrest.data.conn;

import ir.oddrun.befrest.model.exception.HttpRequestFailedException;
    ...
    private static String fetchRawResponse(HttpRequestBase request) throws Exception {
        ...
        try (CloseableHttpResponse response = httpClient.execute(request)) {
            ...
            if (statusCode == HttpStatus.SC_OK) {
                ...
                throw new HttpRequestFailedException(String.format(
